...
insert into article(id, title, price, supplierId, type) VALUES (1008, 'BoekFictie1', 12, 'Book Studio', 'book');
insert into book(id, author, isbn, numberOfPages, booktype ) VALUES (1008, 'kweni', '978-90-1234-567-8', 586, 'fiction');
insert into bookfiction(id, bookGenre, summary) VALUES (1008, 2, 'eomqzioejzcfjeiuhpgciqzmjmfosfghaefjze iofergeqifjemqelsh');

insert into article(id, title, price, supplierId, type) VALUES (1009, 'BoekNONFictie1', 8, 'Book NON Studio', 'book');
insert into book(id, author, isbn, numberOfPages, booktype ) VALUES (1009, 'dunno', '978-90-1234-567-9', 256, 'nonfiction');
